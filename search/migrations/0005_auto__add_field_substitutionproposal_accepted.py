...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubstitutionProposal.accepted'
        db.add_column(u'search_substitutionproposal', 'accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubstitutionProposal.accepted'
        db.delete_column(u'search_substitutionproposal', 'accepted')
