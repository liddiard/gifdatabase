...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFavorite.date_favorited'
        db.add_column(u'search_userfavorite', 'date_favorited',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 8, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserFavorite.date_favorited'
        db.delete_column(u'search_userfavorite', 'date_favorited')
