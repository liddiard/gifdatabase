...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TagInstance.downs'
        db.alter_column(u'search_taginstance', 'downs', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'TagInstance.ups'
        db.alter_column(u'search_taginstance', 'ups', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'TagInstance.downs'
        db.alter_column(u'search_taginstance', 'downs', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'TagInstance.ups'
        db.alter_column(u'search_taginstance', 'ups', self.gf('django.db.models.fields.IntegerField')())
