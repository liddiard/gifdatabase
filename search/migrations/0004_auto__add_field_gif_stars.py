...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gif.stars'
        db.add_column(u'search_gif', 'stars',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gif.stars'
        db.delete_column(u'search_gif', 'stars')
    ...
    models = {
        ...
        u'search.gif': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'stars': ('django.db.models.fields.PositiveIntegerField', [], {}),
