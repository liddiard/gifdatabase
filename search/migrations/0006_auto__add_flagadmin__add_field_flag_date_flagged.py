...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Flag.date_flagged'
        db.add_column(u'search_flag', 'date_flagged',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Flag.date_flagged'
        db.delete_column(u'search_flag', 'date_flagged')
