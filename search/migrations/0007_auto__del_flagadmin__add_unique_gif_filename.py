...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'FlagAdmin'
        db.delete_table(u'search_flagadmin')

        # Adding unique constraint on 'Gif', fields ['filename']
        db.create_unique(u'search_gif', ['filename'])


    def backwards(self, orm):
        # Removing unique constraint on 'Gif', fields ['filename']
        db.delete_unique(u'search_gif', ['filename'])

        # Adding model 'FlagAdmin'
        db.create_table(u'search_flagadmin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'search', ['FlagAdmin'])
    ...
    models = {
        ...
        u'search.gif': {
            ...
            'host': ('django.db.models.fields.CharField', [], {'default': "'imgur'", 'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
